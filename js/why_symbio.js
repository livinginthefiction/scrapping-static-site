...
//     document.getElementById('static-1').animate()
// }
$(window).scroll(function(){ 

    var a = document.getElementById('landLife').offsetTop;
...
first.addEventListener("mousemove",(e)=>{
    ...
    masker.setAttributeNS(null,"cx",m.x)
    masker.setAttributeNS(null,"cy",m.y)
    dot.setAttributeNS(null,"cx",m.x)
    dot.setAttributeNS(null,"cy",m.y)
})
